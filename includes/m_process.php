...
if (isset($_POST['pinjam'])) {
	...
	count($existId);
	if (count($existId) > 0) {
		$db->execute("INSERT INTO tb_pinjamdetail (kodePinjam, kodeBuku ) VALUES ('$kodePinjam','$kodeBuku') ");
	} else {
		$db->execute("INSERT INTO tb_pinjam (kodePinjam, kodePeminjam, type, tglPinjam )VALUES ('$kodePinjam', '$kodePeminjam','$type','$tglPinjam') ");
		$db->execute("INSERT INTO tb_pinjamdetail (kodePinjam, kodeBuku )VALUES ('$kodePinjam','$kodeBuku') ");
	}
	redirect("index.php", "");
}
